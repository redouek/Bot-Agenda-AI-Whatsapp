...
function buildPrompt({ history, pendingAction, userText, mediaKind }) {
  ...
  return [
    ...
    'CANCELAMENTO "AMBOS/TODOS" SEM NOME: se o usuario disser "cancela ambos", "cancela os dois", "cancela todos", "remove tudo" SEM citar o nome, identifique pelo HISTORICO o titulo dos eventos recem-criados (procure por "Eventos agendados com sucesso:" ou "Evento agendado com sucesso: X") e produza cancel_event com query=titulo (ou palavras-chave) desses eventos. NUNCA pergunte "quais eventos?" se o historico recente mostra criacao clara. Inclua period apropriado se souber das datas pelo historico.',
