...
function buildPrompt({ history, pendingAction, userText, mediaKind }) {
  ...
  return [
    ...
    'Se a mensagem pedir clima/tempo/previsao do tempo/vai chover, produza lookup com source weather e query contendo APENAS o nome da cidade. Use period ("today", "tomorrow", "this_week") quando o usuario especificar. Exemplos: "como esta o tempo em SP" -> { source: "weather", query: "São Paulo" }; "vai chover amanha no Rio?" -> { source: "weather", query: "Rio de Janeiro", period: "tomorrow" }; "previsao da semana em Lisboa" -> { source: "weather", query: "Lisboa", period: "this_week" }. Se o usuario nao especificar cidade, produza chat pedindo qual cidade.',
